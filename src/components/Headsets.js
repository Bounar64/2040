      ...
      <div className="container mx-auto">
        ...
        <div className="grid gap-y-4 lg:grid-cols-2 lg:gap-9">
          ...
          >
            ...
            <div className="absolute bottom-0 bg-white/20 backdrop-blur-md
            max-w-[300px] min-h-[150px] p-6">
              <h4 className="font-semibold text-xl mb-2">Metaverse</h4>
              <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magni
                sequi quasi culpa nulla nostrum quia dignissimos debitis nobis
                praesentium tempore.
              </p>
            </div>
          </div>
